...
function ButtClicked(e) {
  ...
  cli++;
  if (cli === 10) {
    gocomps.innerHTML = "<a href = '/rimbomisra/InsultU/views/comps.pug' class='gocomp' >Get some compliments</a>"
  }
  console.log(k);
  ...
  if (i === k) {
    ...
    setTimeout(() => {
      ...
      k = randomInt(2, 5);
      if (unmute.style.display !== "none" && currPath === "/rimbomisra/InsultU/views/index.pug") {
        lasnd.play();
      }
    }, 2500);
  }
